/* PURPOSE: Creates a game object with its three callback functions and marks it with flags 0x156.
 *
 ...
 * 0x156 into the object's field at offset 0x28 (probably a flag bitmask).
 */
...
typedef struct {
    char pad_00[0x28];
    int flags;              /* 0x28: set to 0x156 right after creation */
} CallbackObject;
...
void func_0209c198(void)
{
    ...
    obj->flags = 0x156;     /* 0x156 is not ARM-immediate encodable -> literal pool, as in ROM */
}
