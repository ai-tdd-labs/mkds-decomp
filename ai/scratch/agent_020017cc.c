/* PURPOSE: Finishes the corrupted-save notice and advances the logo screen.
 * This function takes no arguments and returns no value.
 * It closes the notice when any dialog button is pressed.
 * Otherwise, once the dialog finishes, it probably requests logo state 3.
 */
...
void Logo_StateHandler_NotifySaveDataCorrupted_Second(void)
{
    LogoStateRequest *stateRequest;
