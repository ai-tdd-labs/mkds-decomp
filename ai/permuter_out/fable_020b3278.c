 ...
 *
 * NOTE: matches only with mwccarm 1.2/base (aimatch --mwcc 1.2/base).
 * The thumb jumptable dispatch (ldrh [r0,#8]; lsls/asrs #16; add r0,pc;
 * bx r0) is the 1.2/base fingerprint; sp2p3 emits add pc,r0 instead.
 */
