...
// The seven integer values are forwarded to the background setup routine.
...
void DisplayConfig_SetTopEngineBg1Config(char *base, int a1, int a2, int a3, int a4, int a5, int a6, int a7)
{
