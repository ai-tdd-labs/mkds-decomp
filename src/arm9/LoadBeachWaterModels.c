/*
PURPOSE: Loads the beach water models and prepares their effect settings.

This function takes no arguments. It probably allocates the shared water-effect
state, configures its position and animation values, loads two beach model
files, and then initializes the completed state.
*/
...
extern int data_0216bd80;
extern int data_0216bd94;

void LoadBeachWaterModels(void) {
    ...
    data_0217b678->water_model_a =
        FormatFindMapObjFileBuffer_from_thumb(&data_0216bd80);
    data_0217b678->water_model_c =
        FormatFindMapObjFileBuffer_from_thumb(&data_0216bd94);
