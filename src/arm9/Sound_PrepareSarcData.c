// PURPOSE: Prepares archive data for the sound system.
// Loads the requested sound archive data if it is not already available.
...
void *Sound_PrepareSarcData(u32 fileId, void *heap, int useActiveSdat)
{
    void *rawFile;
