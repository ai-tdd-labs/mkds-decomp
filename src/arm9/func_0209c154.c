/* PURPOSE: Creates a game object with its three callback functions and marks it with flags 0x155.
 *
 ...
 * 0x155 into the object's field at offset 0x28 (probably a flag bitmask).
 */
...
typedef struct {
    char pad_00[0x28];
    int flags;              /* 0x28: set to 0x155 right after creation */
} CallbackObject;
