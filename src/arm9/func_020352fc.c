// PURPOSE: Starts the previous available dialog sound.
// The argument permits wrapping from the first slot back to the last slot.
...
void func_020352fc(int allowWrap)
{
    int entry;
    int found;
